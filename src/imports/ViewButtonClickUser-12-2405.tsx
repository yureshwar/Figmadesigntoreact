import svgPaths from "./svg-k4wo7ducks";
...
function Wrapper2({ children, additionalClassNames = "" }: React.PropsWithChildren<Wrapper2Props>) {
  return (
    <div style={{ fontVariationSettings: "'wdth' 100" }} className={clsx("absolute flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] left-[34px] text-nowrap tracking-[0.25px] translate-y-[-50%]", additionalClassNames)}>
...
function Group3() {
  return (
    <div className="absolute contents left-1/2 top-[66px] translate-x-[-50%]">
      ...
      <Wrapper2 additionalClassNames="text-[20px] text-white top-[89px]">Home</Wrapper2>
      <MaterialSymbolsEdit />
    </div>
  );
}
...
function Group12() {
  return (
    <div className="absolute h-[30px] left-[372px] top-[297px] w-[28px]">
...
function Group8() {
  return (
    <div className="absolute contents left-[16px] top-[289px]">
      <div className="absolute bg-white h-[46px] left-1/2 rounded-[8px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] top-[289px] translate-x-[-50%] w-[392px]" />
      <Wrapper2 additionalClassNames="text-[14px] text-black top-[312px]">
        Custom Tool Tip (
...
function BasesCheckbox() {
  return (
    <div className="absolute content-stretch flex inset-[34.96%_90.98%_59.96%_3.22%] items-center justify-center" data-name=".bases / checkbox">
      <Thumb />
    </div>
  );
}
...
function BasesCheckbox1() {
  return (
    <div className="absolute content-stretch flex inset-[34.96%_43.45%_59.96%_50.75%] items-center justify-center" data-name=".bases / checkbox">
      <Thumb />
    </div>
  );
}
...
function Group4() {
  return (
    <div className="absolute contents left-[16px] top-[235px]">
      ...
      <p className="absolute font-['Raleway:Regular',sans-serif] font-normal leading-[normal] left-[27px] text-[14px] text-black text-nowrap top-[251px] whitespace-pre">High Light</p>
    </div>
  );
}
...
function Group6() {
  return (
    <div className="absolute contents left-[16px] top-[344px]">
      <div className="absolute bg-white border border-[#c8c8c8] border-solid h-[46px] left-[16px] rounded-[8px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] top-[344px] w-[392px]" />
      <p className="absolute font-['Raleway:Regular',sans-serif] font-normal leading-[normal] left-[27px] text-[14px] text-black text-nowrap top-[360px] whitespace-pre">Delay in seconds (optional)</p>
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="absolute bg-[#d5d5d5] h-[472px] left-[29px] overflow-clip rounded-[8px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] top-[188px] w-[424px]">
      <Frame4 />
      <Group3 />
      <Group7 />
...
function Component3() {
  return (
    <div className="absolute h-[156px] left-[28px] top-[671px] w-[424px]" data-name="Component 12">
...
function Frame3() {
  return (
    <div className="absolute content-stretch flex gap-[10px] items-center left-[calc(50%+1px)] top-[594px] translate-x-[-50%] w-[392px]">
      <SubmitButton1 />
      <SubmitButton2 />
    </div>
  );
