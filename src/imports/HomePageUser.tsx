import svgPaths from "./svg-s04gq19zek";
...
function Group3() {
  return (
    <Wrapper2 additionalClassNames="left-[16.5px] top-[calc(50%-465px)] translate-y-[-50%]">
...
function Group1() {
  return (
    <Wrapper2 additionalClassNames="left-[448px] top-[23px]">
...
function SettingsButton() {
  return (
    <Wrapper2 additionalClassNames="left-[412.5px] top-[23px]">
...
function MaterialSymbolsSearchRounded() {
  return (
    <Wrapper2 additionalClassNames="left-[21px] top-[79px]">
