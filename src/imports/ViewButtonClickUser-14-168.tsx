import svgPaths from "./svg-kh6ah24w99";
...
function Group4() {
  return (
    <Wrapper additionalClassNames="left-[12px] top-[calc(50%-463px)] translate-y-[-50%]">
...
function BetaTag() {
  return (
    <div className="absolute bg-[#cccccc] h-[14px] left-[256.61px] overflow-clip rounded-[4px] top-[34px] w-[30.199px]" data-name="Beta Tag">
...
function Heading() {
  return (
    <div className="absolute contents left-[162.99px] top-[18px]" data-name="Heading">
      <p className="absolute font-['Raleway:Regular',sans-serif] font-normal leading-[normal] left-[162.99px] text-[32px] text-black top-[18px] w-[93.616px]">UDAN</p>
      <BetaTag />
    </div>
  );
}
...
function Group2() {
  return (
    <Wrapper additionalClassNames="left-[443.5px] top-[25px]">
...
function SettingsButton() {
  return (
    <Wrapper additionalClassNames="left-[408px] top-[25px]">
...
function RecordButton() {
  return (
    <div className="absolute bg-[rgba(251,44,54,0.1)] content-stretch flex gap-[4px] h-[24px] items-center justify-center left-[348px] p-[8px] rounded-[1000px] top-[25px] w-[48px]" data-name="Record Button">
...
function Group1() {
  return (
    <div className="absolute contents left-[calc(50%-0.25px)] top-[18px] translate-x-[-50%]">
      <Group4 />
      <Heading />
      <Group2 />
      <SettingsButton />
...
function Group() {
  return (
    <div className="absolute inset-[8.33%_10.37%]" data-name="Group">
      <div className="absolute inset-[-2.73%_-2.87%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 37 39">
          <g id="Group">
            <path d={svgPaths.p155e3300} fill="var(--fill-0, #2F88FF)" id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
            <path d={svgPaths.p279bc300} id="Vector_2" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          </g>
        </svg>
      </div>
    </div>
...
function IconParkSuccess() {
  return (
    <div className="absolute left-[75px] overflow-clip size-[44px] top-[540px]" data-name="icon-park:success">
      <Group />
    </div>
  );
}
...
function Group5() {
  return (
    <div className="absolute contents left-[75px] top-[540px]">
      <p className="absolute font-['Roboto:SemiBold',sans-serif] font-semibold leading-[normal] left-[127px] text-[32px] text-black text-justify text-nowrap top-[544px] whitespace-pre" style={{ fontVariationSettings: "'wdth' 100" }}>
        Saved Successfully
      </p>
      <IconParkSuccess />
    </div>
...
function SubmitButton() {
  return (
    <div className="absolute bg-black content-stretch flex items-center justify-center left-1/2 px-[12px] py-[16px] rounded-[8px] top-[882px] translate-x-[-50%] w-[456px]" data-name="Submit button">
      <p className="font-['Raleway:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[20px] text-nowrap text-white whitespace-pre">Done</p>
    </div>
  );
}
...
export default function ViewButtonClickUser() {
  return (
    <div className="bg-[#f6f6f6] relative size-full" data-name="View Button Click - User">
      <Group1 />
      <Footer />
      <div className="absolute left-[84px] size-[312px] top-[196px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 312 312">
          <path d={svgPaths.p38c89300} fill="var(--fill-0, #D9D9D9)" id="Ellipse 11" />
        </svg>
      </div>
      <div className="absolute left-[84px] size-[312px] top-[196px]">
        <div className="absolute inset-[0_0.39%_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 311 312">
            <path d={svgPaths.p1a5de5e0} fill="var(--fill-0, black)" id="Ellipse 12" />
          </svg>
        </div>
      </div>
      <p className="absolute font-['Roboto:SemiBold',sans-serif] font-semibold leading-[normal] left-[179px] text-[64px] text-black text-justify text-nowrap top-[314px] whitespace-pre" style={{ fontVariationSettings: "'wdth' 100" }}>
        96%
      </p>
      <Group5 />
      <SubmitButton />
