import svgPaths from "./svg-3hlsnpmccu";
...
function Wrapper({ children, additionalClassNames = "" }: React.PropsWithChildren<WrapperProps>) {
  return (
    <div className={clsx("absolute size-[32.211px] top-[74.89px]", additionalClassNames)}>
      <div className="absolute inset-[0_-12.42%_-24.84%_-12.42%]">
...
function Text({ text, additionalClassNames = "" }: TextProps) {
  return (
    <div className={clsx("absolute h-[16px] rounded-[2px] top-[39px] w-[30px]", additionalClassNames)}>
...
function ThumbUp() {
  return (
    <Wrapper2 additionalClassNames="left-[356px] top-[209px]">
...
function ThumbDown() {
  return (
    <Wrapper2 additionalClassNames="left-[400px] top-[209px]">
...
function RecordingStepFail() {
  return (
    <div className="absolute content-stretch flex gap-[10px] inset-[0_24.66%_29.03%_0] items-center p-[10px]" data-name="Recording Step Fail">
      <Cancel />
...
function Frame() {
  return (
    <div className="absolute bg-white h-[58px] left-[256px] overflow-clip rounded-[4px] top-[166px] w-[179px]">
      <p className="absolute font-['Raleway:SemiBold',sans-serif] font-semibold leading-[normal] left-[10px] text-[10px] text-black text-nowrap top-[6px] whitespace-pre">Delete Recording</p>
      <p className="absolute font-['Raleway:SemiBold',sans-serif] font-semibold leading-[normal] left-[10px] text-[10px] text-black text-nowrap top-[23px] whitespace-pre">Are you Sure You Want to Delete?</p>
      <Text text="Yes" additionalClassNames="bg-[#1c1c1e] left-[139px]" />
      <Text text="No" additionalClassNames="bg-[#969696] left-[107px]" />
    </div>
  );
}
...
function Group7() {
  return (
    <div className="absolute contents left-[256px] top-[160px]">
      <Frame />
      <div className="absolute left-[418px] size-[9px] top-[160px]">
        <div className="absolute bottom-1/4 left-[6.7%] right-[6.7%] top-0">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8 7">
            <path d={svgPaths.p18c08980} fill="var(--fill-0, white)" id="Polygon 3" />
          </svg>
        </div>
      </div>
    </div>
