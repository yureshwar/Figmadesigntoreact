import svgPaths from "./svg-onrwwfl8wg";
...
function Frame() {
  return (
    <div className="absolute bg-white content-stretch flex h-[30px] items-center justify-center left-[88px] p-[10px] rounded-[4px] top-[609px]">
      <p className="font-['Montserrat:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[16px] text-black text-nowrap whitespace-pre">! Unable to find</p>
    </div>
  );
}
...
function Group3() {
  return (
    <div className="absolute contents left-[88px] top-[602px]">
      <Frame />
      <div className="absolute h-[10px] left-[93px] top-[602px] w-[11px]">
        <div className="absolute bottom-1/4 left-[6.7%] right-[6.7%] top-0">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 8">
            <path d={svgPaths.p4e54100} fill="var(--fill-0, white)" id="Polygon 1" />
          </svg>
        </div>
      </div>
    </div>
