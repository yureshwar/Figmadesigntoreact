import svgPaths from "./svg-cqzy54jtn1";
...
function StartingRecordingContainer() {
  return (
    <div className="relative shrink-0 w-full" data-name="Starting Recording Container">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col font-['Raleway:SemiBold',sans-serif] font-semibold gap-[10px] items-center justify-center leading-[0] p-[16px] relative text-[#1c1c1e] text-center w-full">
...
function BodyContent() {
  return (
    <div className="absolute content-stretch flex flex-col h-[783px] items-start left-1/2 top-[calc(50%+19.5px)] translate-x-[-50%] translate-y-[-50%] w-[456px]" data-name="Body Content">
      <Frame />
    </div>
  );
}
...
function MaterialSymbolsSearchRounded() {
  return (
    <Wrapper additionalClassNames="left-[21px] top-[79px]">
...
function Component() {
  return (
    <div className="absolute h-[32.211px] left-[398px] top-[74.89px] w-[31.861px]" data-name="Component 1">
      <Wrapper1>
        <g id="Component 1">
